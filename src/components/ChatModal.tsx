...
export default function ChatModal({
  ...
  const SkillBadge = ({ skill }: { skill: string }) => (
    <span className="px-3 py-1.5 bg-linear-to-r from-blue-500/20 to-purple-500/20 text-blue-300 rounded-lg text-sm border border-blue-400/30 hover:border-blue-400/60 transition-all hover:scale-105">
      {skill}
    </span>
  );
  ...
  return (
    <Transition appear show={true} as={Fragment}>
      ...
      >
        {/* Overlay (kliknięcie poza Panel zamknie Dialog automatycznie) */}
        <div
        ...
        <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-8">
          <DialogPanel
            className="bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl max-w-7xl w-full max-h-[95vh] overflow-hidden flex flex-col border border-gray-700/50 landscape-low:... "
            // stopPropagation nie jest potrzebne dla Panel (Headless UI zarządza kliknięciami poza)
          >
            {/* Header z tabami */}
            <div className="bg-gray-900/50 border-b border-gray-700/50 p-3 sm:p-4 xl:p-6 landscape-low:p-2 landscape-low:py-1">
              <div className="flex items-start justify-between mb-3 sm:mb-3 xl:mb-4 landscape-low:mb-1">
                <div className="flex items-center gap-2 sm:gap-3 xl:gap-4 landscape-low:gap-1">
                  ...
                  <div>
                    ...
                    <span className="inline-block px-2 sm:px-3 xl:px-4 py-1 sm:py-1 xl:py-1.5 bg-linear-to-r from-blue-600/30 to-purple-600/30 text-blue-300 rounded-full text-xs sm:text-xs xl:text-sm">
                      {chat.category}
                    </span>
                  </div>
                </div>
              ...
              <div className="flex gap-1 sm:gap-1.5 xl:gap-2 landscape-low:gap-0.5">
                <button
                  ...
                  className={`px-3 sm:px-4 xl:px-6 py-2 sm:py-2 xl:py-2.5 rounded-lg font-medium transition-all text-xs sm:text-sm xl:text-base landscape-low:px-2 landscape-low:py-1 ${
                    activeTab === "content"
                          ...
                          >
                            ...
                            >
                              <div className="flex items-start gap-2 sm:gap-4 landscape-low:gap-1">
                                <div className="shrink-0 w-6 h-6 sm:w-8 sm:h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xs sm:text-sm landscape-low:w-4 landscape-low:h-4">
                                  Q{index + 1}
                                </div>
                            ...
                            >
                              <div className="flex items-start gap-2 sm:gap-4 landscape-low:gap-1">
                                <div className="shrink-0 w-6 h-6 sm:w-8 sm:h-8 bg-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-xs sm:text-sm landscape-low:w-4 landscape-low:h-4">
                                  A
                                </div>
                                <div className="flex-1 min-w-0">
                                  ...
                                  {!isExpanded &&
                                    exchange.answer.length > 200 && (
                                      <button
                                        onClick={() => toggleItem(index)}
                                        className="text-purple-400 text-xs sm:text-sm mt-2 sm:mt-3 hover:text-purple-300 transition-colors inline-flex items-center gap-1 landscape-low:text-[10px]"
                                      >
