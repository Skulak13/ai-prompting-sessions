  ...
  return (
    <footer className="bg-gray-800 border-t border-gray-700 px-8 py-1 md:py-4">
      <div className="flex items-center justify-center gap-6">
        ...
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M.76 12.2l5.753 5.753L12 12.406 6.513 6.91zm11.48 3.646L6.487 21.6 11.907 24l5.753-5.753zm.48-3.646l5.753 5.753L24 11.76l-5.76-5.76zm11.28 3.646l-5.753 5.753L24 24l-5.753-5.753z" />
          </svg>
          <span>Codewars</span>
        </a>
      </div>
